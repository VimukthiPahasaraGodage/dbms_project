		...
		<div class="row">
          ...
          if($row['quantity']==0){
            continue;
                    ...
                    echo('
					<div style="align="center";"  class="col-sm-6 col-lg-3 col-md-4 text-center">
					<div class="card" style="width:220px; height:500px;margin-bottom:10px;background:none;border:0;">
					...
					<p class="card-text">'.$row['price'].'.00LKR</p>
					<a href="addToCard.php?id='.$row['product_id'].'" class="btn btn-primary">View Details</a>
					</div>
					</div>
					</div>
					');
