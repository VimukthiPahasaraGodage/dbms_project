...
<a style="width:40%;" href="card.php" name="signup" type="submit" class="btn btn-success">Cancel Order</a>
<a style="width:40%;float:right;" href="order.php" name="signup" type="submit" class="btn btn-success">Confirm Order</a>
</form>
